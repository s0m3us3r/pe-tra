...
var MultiSectionDigitalClock = React7.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
    name: "MuiMultiSectionDigitalClock"
  ...
  const timeSteps = React7.useMemo(() => _extends({
    hours: 1,
    minutes: 5,
    seconds: 5
  ...
  const isTimeDisabled = React7.useCallback((rawValue, viewType) => {
  ...
  const buildViewProps = React7.useCallback((viewToBuild) => {
    switch (viewToBuild) {
      case "hours": {
        return {
          onChange: (hours) => {
  ...
  const viewTimeOptions = React7.useMemo(() => {
...
function Clock(inProps) {
  ...
  return (0, import_jsx_runtime10.jsxs)(ClockRoot, {
    ...
    children: [(0, import_jsx_runtime10.jsxs)(ClockClock, {
      ...
      }), !isSelectedTimeDisabled && (0, import_jsx_runtime10.jsxs)(React9.Fragment, {
    ...
    }), ampm && ampmInClock && (0, import_jsx_runtime10.jsxs)(React9.Fragment, {
  ...
  return (0, import_jsx_runtime18.jsxs)(React15.Fragment, {
    children: [(0, import_jsx_runtime18.jsxs)(DateTimeViewWrapper, {
      children: [(0, import_jsx_runtime17.jsx)(DateCalendar, {
        ...
        displayWeekNumber,
        timezone
      }), timeViewsCount > 0 && (0, import_jsx_runtime18.jsxs)(React15.Fragment, {
...
//# sourceMappingURL=chunk-QRZTSQW3.js.map
