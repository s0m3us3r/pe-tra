  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime9.jsx)(ListContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime10.jsxs)(ListItemContainer, _extends({
        ...
        children: [(0, import_jsx_runtime9.jsx)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
          as: Component,
...
var _excluded7 = ["animation", "className", "component", "height", "style", "variant", "width"];
var _ = (t) => t;
var _t;
var _t2;
var _t3;
...
var Skeleton = React8.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(SkeletonRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    ownerState
...
var _excluded8 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React9.forwardRef(function Tab2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React9.isValidElement(iconProp) ? React9.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime12.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime12.jsxs)(React9.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime12.jsxs)(React9.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var TabScrollButton = React12.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime15.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime15.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var Tabs = React14.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime17.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime17.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime17.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime17.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime18.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime18.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime17.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
//# sourceMappingURL=chunk-JB3PR5HX.js.map
