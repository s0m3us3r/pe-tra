...
Clock.propTypes = {
  ...
  formatHour: import_prop_types6.default.func,
  ...
  renderHourMarks: import_prop_types6.default.bool,
  renderMinuteHand: import_prop_types6.default.bool,
  renderMinuteMarks: import_prop_types6.default.bool,
  renderNumbers: import_prop_types6.default.bool,
  renderSecondHand: import_prop_types6.default.bool,
  ...
  value: import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.instanceOf(Date)])
};
...
var Fit = (
  ...
  function(_super) {
    ...
    Fit2.propTypes = {
      ...
      invertAxis: import_prop_types7.default.bool,
      invertSecondaryAxis: import_prop_types7.default.bool,
      mainAxis: import_prop_types7.default.oneOf(["x", "y"]),
      spacing: import_prop_types7.default.oneOfType([
...
var allValueTypes2 = __spreadArray6([], allViews4, true);
...
var isValueType = import_prop_types8.default.oneOf(allValueTypes2);
var rangeOf2 = function(type) {
  return import_prop_types8.default.arrayOf(type);
};
...
var isValue3 = import_prop_types9.default.oneOfType([import_prop_types9.default.string, import_prop_types9.default.instanceOf(Date)]);
var isValueOrValueArray2 = import_prop_types9.default.oneOfType([isValue3, rangeOf2(isValue3)]);
DateTimePicker.propTypes = {
  amPmAriaLabel: import_prop_types9.default.string,
  autoFocus: import_prop_types9.default.bool,
  calendarAriaLabel: import_prop_types9.default.string,
  calendarClassName: import_prop_types9.default.oneOfType([import_prop_types9.default.string, import_prop_types9.default.arrayOf(import_prop_types9.default.string)]),
  calendarIcon: import_prop_types9.default.oneOfType([import_prop_types9.default.node, import_prop_types9.default.func]),
  className: import_prop_types9.default.oneOfType([import_prop_types9.default.string, import_prop_types9.default.arrayOf(import_prop_types9.default.string)]),
  clearAriaLabel: import_prop_types9.default.string,
  clearIcon: import_prop_types9.default.oneOfType([import_prop_types9.default.node, import_prop_types9.default.func]),
  clockClassName: import_prop_types9.default.oneOfType([import_prop_types9.default.string, import_prop_types9.default.arrayOf(import_prop_types9.default.string)]),
  closeWidgets: import_prop_types9.default.bool,
  "data-testid": import_prop_types9.default.string,
  dayAriaLabel: import_prop_types9.default.string,
  dayPlaceholder: import_prop_types9.default.string,
  disableCalendar: import_prop_types9.default.bool,
  disableClock: import_prop_types9.default.bool,
  disabled: import_prop_types9.default.bool,
  format: import_prop_types9.default.string,
  hourAriaLabel: import_prop_types9.default.string,
  hourPlaceholder: import_prop_types9.default.string,
  id: import_prop_types9.default.string,
  isCalendarOpen: import_prop_types9.default.bool,
  isClockOpen: import_prop_types9.default.bool,
  locale: import_prop_types9.default.string,
  maxDate: isMaxDate3,
  maxDetail: import_prop_types9.default.oneOf(allViews5),
  minDate: isMinDate3,
  minuteAriaLabel: import_prop_types9.default.string,
  minutePlaceholder: import_prop_types9.default.string,
  monthAriaLabel: import_prop_types9.default.string,
  monthPlaceholder: import_prop_types9.default.string,
  name: import_prop_types9.default.string,
  nativeInputAriaLabel: import_prop_types9.default.string,
  onCalendarClose: import_prop_types9.default.func,
  onCalendarOpen: import_prop_types9.default.func,
  onChange: import_prop_types9.default.func,
  onClockClose: import_prop_types9.default.func,
  onClockOpen: import_prop_types9.default.func,
  onFocus: import_prop_types9.default.func,
  openWidgetsOnFocus: import_prop_types9.default.bool,
  required: import_prop_types9.default.bool,
  secondAriaLabel: import_prop_types9.default.string,
  secondPlaceholder: import_prop_types9.default.string,
  showLeadingZeros: import_prop_types9.default.bool,
  value: isValueOrValueArray2,
  yearAriaLabel: import_prop_types9.default.string,
  yearPlaceholder: import_prop_types9.default.string
};
if (isBrowser4) {
  DateTimePicker.propTypes.portalContainer = import_prop_types9.default.instanceOf(HTMLElement);
}
